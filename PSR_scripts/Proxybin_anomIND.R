...
SSTproxy<-read.csv("/Users/Casey_JISAO/Google Drive/R_documents/PSR/proxy_data/SST/SSTProxyDat.csv", header=T);
O18proxy<-read.csv("/Users/Casey_JISAO/Google Drive/R_documents/PSR/proxy_data/O18/O18ProxyDat.csv", header=T);
