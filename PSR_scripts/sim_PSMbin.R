...
HadpiC_T_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/HadpiC_T_O18")
HadpiC_T_O18<-HadpiC_T_O18[,-1]																					#delete first column of NAs
HadpiC_H2O18_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/HadpiC_H2O18_O18")
HadpiC_H2O18_O18<-HadpiC_H2O18_O18[,-1]
HadpiC_H2O18_O18<-(HadpiC_H2O18_O18/R18SMOW-1)*1000																#convert to delta notation
HadpiC_T_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/HadpiC_T_MgCa")
HadpiC_T_MgCa<-HadpiC_T_MgCa[,-1]
HadpiC_salt_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/HadpiC_salt_MgCa")
HadpiC_salt_MgCa<-HadpiC_salt_MgCa[,-1]
HadpiC_AMOC<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/HadpiC_AMOC")
HadpiC_NAM<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/HadpiC_NAM")
HadpiC_NAO<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/HadpiC_NAO")

GISSgCpiC_T_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgCpiC_T_O18")
...
GISSgCpiC_H2O18_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgCpiC_H2O18_O18")
GISSgCpiC_H2O18_O18<-GISSgCpiC_H2O18_O18[,-1]
GISSgCpiC_T_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgCpiC_T_MgCa")
...
GISSgCpiC_salt_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgCpiC_salt_MgCa")
...
GISSgCpiC_AMOC<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgCpiC_AMOC")
GISSgCpiC_NAM<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgCpiC_NAM")
GISSgCpiC_NAO<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgCpiC_NAO")

GISSgy3piC_T_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgy3piC_T_O18")
GISSgy3piC_T_O18<-GISSgy3piC_T_O18[,-1]
GISSgy3piC_H2O18_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgy3piC_H2O18_O18")
GISSgy3piC_H2O18_O18<-GISSgy3piC_H2O18_O18[,-1]
GISSgy3piC_T_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgy3piC_T_MgCa")
GISSgy3piC_T_MgCa<-GISSgy3piC_T_MgCa[,-1]
GISSgy3piC_salt_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgy3piC_salt_MgCa")
GISSgy3piC_salt_MgCa<-GISSgy3piC_salt_MgCa[,-1]
GISSgy3piC_AMOC<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgy3piC_AMOC")
GISSgy3piC_NAM<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgy3piC_NAM")
GISSgy3piC_NAO<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgy3piC_NAO")

GISSgTckLM_T_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTckLM_T_O18")
GISSgTckLM_T_O18<-GISSgTckLM_T_O18[,-1]
GISSgTckLM_H2O18_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTckLM_H2O18_O18")
GISSgTckLM_H2O18_O18<-GISSgTckLM_H2O18_O18[,-1]
GISSgTckLM_T_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTckLM_T_MgCa")
GISSgTckLM_T_MgCa<-GISSgTckLM_T_MgCa[,-1]
GISSgTckLM_salt_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTckLM_salt_MgCa")
GISSgTckLM_salt_MgCa<-GISSgTckLM_salt_MgCa[,-1]
GISSgTckLM_AMOC<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTckLM_AMOC")
GISSgTckLM_NAM<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTckLM_NAM")
GISSgTckLM_NAO<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTckLM_NAO")

GISSgTKckLM_T_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTKckLM_T_O18")
GISSgTKckLM_T_O18<-GISSgTKckLM_T_O18[,-1]
GISSgTKckLM_H2O18_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTKckLM_H2O18_O18")
GISSgTKckLM_H2O18_O18<-GISSgTKckLM_H2O18_O18[,-1]
GISSgTKckLM_T_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTKckLM_T_MgCa")
GISSgTKckLM_T_MgCa<-GISSgTKckLM_T_MgCa[,-1]
GISSgTKckLM_salt_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTKckLM_salt_MgCa")
...
GISSgTKckLM_AMOC<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTKckLM_AMOC")
GISSgTKckLM_NAM<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTKckLM_NAM")
GISSgTKckLM_NAO<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTKckLM_NAO")

GISSgTcsLM_T_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTcsLM_T_O18")
GISSgTcsLM_T_O18<-GISSgTcsLM_T_O18[,-1]
GISSgTcsLM_H2O18_O18<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTcsLM_H2O18_O18")
GISSgTcsLM_H2O18_O18<-GISSgTcsLM_H2O18_O18[,-1]
GISSgTcsLM_T_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTcsLM_T_MgCa")
GISSgTcsLM_T_MgCa<-GISSgTcsLM_T_MgCa[,-1]
GISSgTcsLM_salt_MgCa<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTcsLM_salt_MgCa")
GISSgTcsLM_salt_MgCa<-GISSgTcsLM_salt_MgCa[,-1]
GISSgTcsLM_AMOC<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTcsLM_AMOC")
GISSgTcsLM_NAM<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTcsLM_NAM")
GISSgTcsLM_NAO<-readRDS("/Users/Casey_JISAO/Google Drive/R_documents/PSR/model_data/AnnualData/GISSgTcsLM_NAO")
